  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        ...
        <p className="text-slate-600 mt-1 font-medium">System announcements and alerts.</p>
      </div>
        ...
        <CardContent className="p-0">
          <div className="divide-y divide-slate-100">
            {filteredNotifications.map(notification => (
              <div key={notification.id} className="p-6 bg-white hover:bg-sky-50/50 transition-colors flex gap-4">
                <div className="mt-1">
                  {notification.isRead ? (
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 gap-2">
                    ...
                    <div className="flex items-center space-x-3 shrink-0">
                      <span className="text-[10px] uppercase font-bold tracking-wider bg-white text-slate-600 px-2.5 py-1 rounded-md border border-[#D6ECFA]">
                  ...
                  <p className={`${notification.isRead ? 'text-slate-600' : 'text-slate-600 font-medium'} text-sm leading-relaxed mb-1`}>
