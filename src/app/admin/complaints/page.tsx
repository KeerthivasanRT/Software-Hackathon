    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1 font-medium">Review and resolve transport issues reported by students.</p>
        </div>
      </div>
                  ...
                  <TableRow key={complaint.id} className="hover:bg-slate-50/80 transition-colors border-b border-slate-100">
                    ...
                    <TableCell>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-slate-500 mt-1 max-w-md leading-relaxed">{complaint.description}</div>
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-right px-6">
                      <div className="flex justify-end space-x-2">
                        <Button variant="outline" size="sm" onClick={() => handleStatusChange(complaint.id, 'in-progress')} className="h-8 text-blue-600 border-blue-200/60 hover:bg-blue-50 rounded-lg shadow-sm transition-all text-xs font-semibold">
