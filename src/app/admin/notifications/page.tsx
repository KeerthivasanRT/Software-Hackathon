...
export default function NotificationsPage() {
  ...
  // Admin sees all, driver/student see their role or 'all'
              ...
              <div key={notification.id} className="p-4 rounded-lg border border-slate-200 bg-white shadow-sm flex flex-col">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded capitalize border border-slate-200">
